...
// The following VID/PID pair belongs to APDM Inc. with permission to use on the Marionette project
 ...
 */
#define USBD1_DATA_REQUEST_EP_0           1
#define USBD1_DATA_AVAILABLE_EP_0         1
#define USBD1_INTERRUPT_REQUEST_EP_0      2

#define USBD1_DATA_REQUEST_EP_1           3
#define USBD1_DATA_AVAILABLE_EP_1         3
#define USBD1_INTERRUPT_REQUEST_EP_1      4
...
static const uint8_t vcom_configuration_descriptor_data[141] = {
  ...
  USB_DESC_ENDPOINT     (USBD1_INTERRUPT_REQUEST_EP_0|0x80,
  ...
  USB_DESC_ENDPOINT     (USBD1_DATA_AVAILABLE_EP_0,       /* bEndpointAddress.*/
                         0x02,          /* bmAttributes (Bulk).             */
                         0x0040,        /* wMaxPacketSize.                  */
                         0x00),         /* bInterval.                       */
  /* Endpoint 1 Descriptor.*/
  USB_DESC_ENDPOINT     (USBD1_DATA_REQUEST_EP_0|0x80,    /* bEndpointAddress.*/
                         0x02,          /* bmAttributes (Bulk).             */
                         0x0040,        /* wMaxPacketSize.                  */
                         0x00),         /* bInterval.                       */
  ...
  USB_DESC_BYTE         (0x01),         /* bSlaveInterface0 (Data Class
                                           Interface).                      */
  /* Endpoint 2 Descriptor.*/
  USB_DESC_ENDPOINT     (USBD1_INTERRUPT_REQUEST_EP_1|0x80,
                         0x03,          /* bmAttributes (Interrupt).        */
                         0x0008,        /* wMaxPacketSize.                  */
                         0xFF),         /* bInterval.                       */
  /* Interface Descriptor.*/
  USB_DESC_INTERFACE    (0x03,          /* bInterfaceNumber.                */
                         ...
                         0x00),         /* iInterface.                      */
  /* Endpoint 3 Descriptor.*/
  USB_DESC_ENDPOINT     (USBD1_DATA_AVAILABLE_EP_1,       /* bEndpointAddress.*/
                         0x02,          /* bmAttributes (Bulk).             */
                         0x0040,        /* wMaxPacketSize.                  */
                         0x00),         /* bInterval.                       */
  /* Endpoint 1 Descriptor.*/
  USB_DESC_ENDPOINT     (USBD1_DATA_REQUEST_EP_1|0x80,    /* bEndpointAddress.*/
                         0x02,          /* bmAttributes (Bulk).             */
                         0x0040,        /* wMaxPacketSize.                  */
                         0x00)          /* bInterval.                       */
};
...
static void usb_event(USBDriver *usbp, usbevent_t event) {
  ...
  case USB_EVENT_CONFIGURED:
    ...
    /* Enables the endpoints specified into the configuration.
       ...
       must be used.*/
    usbInitEndpointI(usbp, USBD1_DATA_REQUEST_EP_0, &ep1config);
    usbInitEndpointI(usbp, USBD1_INTERRUPT_REQUEST_EP_0, &ep2config);
    usbInitEndpointI(usbp, USBD1_DATA_REQUEST_EP_1, &ep3config);
    usbInitEndpointI(usbp, USBD1_INTERRUPT_REQUEST_EP_1, &ep4config);
...
const SerialUSBConfig serusbcfg  = {
  &USBD_PERIPHERIAL,
  USBD1_DATA_REQUEST_EP_0,
  USBD1_DATA_AVAILABLE_EP_0,
  USBD1_INTERRUPT_REQUEST_EP_0
};
...
const SerialUSBConfig serusbcfg2 = {
  &USBD_PERIPHERIAL,
  USBD1_DATA_REQUEST_EP_1,
  USBD1_DATA_AVAILABLE_EP_1,
  USBD1_INTERRUPT_REQUEST_EP_1
};
