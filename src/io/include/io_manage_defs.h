...
static io_table_t io_porta =
{
	...
	.pins =
	{
		...
		{.pin = GPIOA_HS_ULPI_D0,        .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB, .current_alloc = IO_USB,  .available_alloc = IO_NONE } ,
		...
		{.pin = GPIOA_HS_ULPI_CK,        .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB, .current_alloc = IO_USB,  .available_alloc = IO_NONE } ,
		...
		{.pin = GPIOA_PIN10,   .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE,  .current_alloc = IO_NONE,   .available_alloc = IO_GPIO } ,
		...
		{.pin = GPIOA_PIN15,        .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_GPIO }
	}
};
...
static io_table_t io_portb =
{
	...
	.pins =
	{
		{ .pin = GPIOB_OTG_HS_ULPI_D1,        .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB, .current_alloc = IO_USB,  .available_alloc = IO_NONE } ,
		{ .pin = GPIOB_OTG_HS_ULPI_D2,        .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB, .current_alloc = IO_USB,  .available_alloc = IO_NONE } ,
		{ .pin = GPIOB_BOOT1,        .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_GPIO, .current_alloc = IO_GPIO,  .available_alloc = IO_NONE } ,
		...
		{ .pin = GPIOB_PIN4,      .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_NONE } ,
		{ .pin = GPIOB_OTG_HS_ULPI_D7,        .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB, .current_alloc = IO_USB,  .available_alloc = IO_NONE } ,
		...
		{ .pin = GPIOB_OTG_HS_ULPI_D3,       .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB, .current_alloc = IO_USB,  .available_alloc = IO_NONE } ,
		{ .pin = GPIOB_OTG_HS_ULPI_D4,       .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB, .current_alloc = IO_USB,  .available_alloc = IO_NONE } ,
		{ .pin = GPIOB_OTG_HS_ULPI_D5,       .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB, .current_alloc = IO_USB,  .available_alloc = IO_NONE } ,
		{ .pin = GPIOB_OTG_HS_ULPI_D6,       .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB, .current_alloc = IO_USB,  .available_alloc = IO_NONE } ,
...
static io_table_t io_portc =
{
	...
	.pins =
	{
		{ .pin = GPIOC_OTG_HS_ULPI_STP,        .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB, .current_alloc = IO_USB,  .available_alloc = IO_NONE} ,
		{ .pin = GPIOC_PIN1, .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,   .available_alloc =  IO_ADC  } ,
		{ .pin = GPIOC_OTG_HS_ULPI_DIR,     .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB, .current_alloc = IO_USB,   .available_alloc = IO_NONE } ,
...
static io_table_t io_porth =
{
	...
	.pins =
	{
		...
		{ .pin = GPIOH_PIN13,       .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_GPIO | IO_CAN} ,
...
static io_table_t io_porti =
{
	...
	.pins =
	{
		...
		{ .pin = GPIOI_PIN9,        .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_GPIO | IO_CAN} ,
