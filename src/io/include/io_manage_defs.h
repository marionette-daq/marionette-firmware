...
static port_pin_t adc1_pins[]   = { { GPIOA, PIN0 },    // ADC_IN0
                                    { GPIOA, PIN1 },    // ADC_IN1
                                    { GPIOA, PIN2 },    // ADC_IN2
                                    { GPIOA, PIN3 },    // ADC_IN3
                                    { GPIOA, PIN4 },    // ADC_IN4
...
static port_pin_t adc2_pins[]   = { { GPIOA, PIN0 },    // ADC_IN0
                                    { GPIOA, PIN1 },    // ADC_IN1
                                    { GPIOA, PIN2 },    // ADC_IN2
                                    { GPIOA, PIN3 },    // ADC_IN3
                                    { GPIOA, PIN4 },    // ADC_IN4
...
static port_pin_t adc3_pins[]   = { { GPIOA, PIN0 },    // ADC_IN0
                                    { GPIOA, PIN1 },    // ADC_IN1
                                    { GPIOA, PIN2 },    // ADC_IN2
                                    { GPIOA, PIN3 },    // ADC_IN3
                                    { GPIOF, PIN6 },    // ADC_IN4
...
static port_pin_t spi1_pins[]   = { { GPIOA, PIN5 },    // SPI_SCK
                                    { GPIOA, PIN6 },    // SPI_MISO
                                    { GPIOA, PIN7 } };  // SPI_MOSI
...
static port_pin_t i2c2_pins[]   = { { GPIOB, PIN10 },   // I2C_SCL
                                    { GPIOB, PIN11 } }; // I2C_SDA
...
static io_table_t io_porta =
{
	...
	.pins =
	{
		...
		{.pin = GPIOA_PIN3_ULPI_D0,.default_mode = PAL_STM32_MODE_ALTERNATE | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB,  .current_alloc = IO_USB,   .available_alloc = IO_USB } ,
		...
		{.pin = GPIOA_PIN5_ULPI_CK,.default_mode = PAL_STM32_MODE_ALTERNATE | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB, .current_alloc = IO_USB,  .available_alloc = IO_USB } ,
...
static io_table_t io_portb =
{
	...
	.pins =
	{
		{ .pin = GPIOB_PIN0_ULPI_D1,.default_mode = PAL_STM32_MODE_ALTERNATE | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB,  .current_alloc = IO_USB,   .available_alloc = IO_USB } ,
		{ .pin = GPIOB_PIN1_ULPI_D2,.default_mode = PAL_STM32_MODE_ALTERNATE | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB,  .current_alloc = IO_USB,   .available_alloc = IO_USB } ,
		...
		{ .pin = GPIOB_PIN_ULPI_N_RST,.default_mode=PAL_STM32_MODE_OUTPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_OUTPUT_PUSHPULL | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_NONE } ,
		{ .pin = GPIOB_PIN5_ULPI_D7,.default_mode = PAL_STM32_MODE_ALTERNATE | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB,  .current_alloc = IO_USB,   .available_alloc = IO_USB } ,
		{ .pin = GPIOB_PIN6,        .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_GPIO | IO_I2C } ,
		...
		{ .pin = GPIOB_PIN10_ULPI_D3,.default_mode= PAL_STM32_MODE_ALTERNATE | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB,  .current_alloc = IO_USB,   .available_alloc = IO_USB } ,
		{ .pin = GPIOB_PIN11_ULPI_D4,.default_mode= PAL_STM32_MODE_ALTERNATE | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB,  .current_alloc = IO_USB,   .available_alloc = IO_USB } ,
		{ .pin = GPIOB_PIN12_ULPI_D5,.default_mode= PAL_STM32_MODE_ALTERNATE | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB,  .current_alloc = IO_USB,   .available_alloc = IO_USB } ,
		{ .pin = GPIOB_PIN13_ULPI_D6,.default_mode= PAL_STM32_MODE_ALTERNATE | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB,  .current_alloc = IO_USB,   .available_alloc = IO_USB } ,
		{ .pin = GPIOB_PIN14_USB_PHY_REFCLK_12MHZ,.default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_NONE } ,
...
static io_table_t io_portc =
{
	...
	.pins =
	{
		{ .pin = GPIOC_PIN0_ULPI_STP,.default_mode= PAL_STM32_MODE_ALTERNATE | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB,  .current_alloc = IO_USB,   .available_alloc = IO_USB } ,
		...
		{ .pin = GPIOC_PIN2_ULPI_DIR,.default_mode= PAL_STM32_MODE_ALTERNATE | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB,  .current_alloc = IO_USB,   .available_alloc = IO_USB } , // REMOVE JUMPER TO USE
...
static io_table_t io_portd =
{
	...
	.pins =
	{
		{ .pin = GPIOD_PIN0,        .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_GPIO | IO_CAN } ,
		{ .pin = GPIOD_PIN1,        .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_GPIO | IO_CAN } ,
...
static io_table_t io_porth =
{
	...
	.pins =
	{
		...
		{ .pin = GPIOH_PIN4_ULPI_NXT,.default_mode= PAL_STM32_MODE_ALTERNATE | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB,  .current_alloc = IO_USB,   .available_alloc = IO_USB } ,
		...
		{ .pin = GPIOH_PIN8,        .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_GPIO | IO_I2C } ,
...
static io_table_t io_porti =
{
	...
	.pins =
	{
		...
		{ .pin = GPIOI_PIN10,       .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_GPIO } ,
...
static io_table_t io_portb =
{
	...
	.pins =
	{
		...
		{ .pin = GPIOB_PIN2,        .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_NONE } ,
		{ .pin = GPIOB_SWO,         .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_NONE } ,
		{ .pin = GPIOB_NJTRST,      .default_mode=PAL_STM32_MODE_OUTPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_OUTPUT_PUSHPULL | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_NONE } ,
		{ .pin = GPIOB_PIN5_ULPI_D7,.default_mode = PAL_STM32_MODE_ALTERNATE | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB,  .current_alloc = IO_USB,   .available_alloc = IO_USB } ,
		{ .pin = GPIOB_PIN6,        .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_GPIO | IO_I2C } ,
		{ .pin = GPIOB_PIN7,        .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_GPIO | IO_I2C } ,
		{ .pin = GPIOB_PIN8,        .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_GPIO | IO_CAN } ,
...
static io_table_t io_portc =
{
	...
	.pins =
	{
		{ .pin = GPIOC_PIN0_ULPI_STP,.default_mode= PAL_STM32_MODE_ALTERNATE | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB,  .current_alloc = IO_USB,   .available_alloc = IO_USB } ,
		{ .pin = GPIOC_OTG_PWR_OUT, .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_USB,   .available_alloc = IO_GPIO | IO_ADC | IO_USB } , // REMOVE JUMPER TO USE
		{ .pin = GPIOC_OTG_FLG,     .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE,  .current_alloc = IO_NONE,   .available_alloc = IO_NONE } , // REMOVE JUMPER TO USE
		{ .pin = GPIOC_PIN3,        .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_GPIO | IO_ADC } ,
		{ .pin = GPIOC_PIN4,        .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_GPIO | IO_ADC } ,
		{ .pin = GPIOC_PIN5,        .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_GPIO | IO_ADC } ,
		{ .pin = GPIOC_PIN6,        .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_GPIO } ,
...
static io_table_t io_porti =
{
	...
	.pins =
	{
		...
		{ .pin = GPIOI_PIN9,        .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_GPIO } ,
		{ .pin = GPIOI_PIN10,       .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_GPIO } ,
		{ .pin = GPIOI_PIN11_ULPI_DIR,.default_mode = PAL_STM32_MODE_ALTERNATE | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB, .current_alloc = IO_USB,  .available_alloc = IO_USB } ,
		{ .pin = GPIOI_PIN12,       .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_GPIO } ,
		{ .pin = GPIOI_PIN13,       .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_GPIO } ,
		{ .pin = GPIOI_PIN14,       .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_GPIO } ,
		{ .pin = GPIOI_PIN15,       .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_NONE, .current_alloc = IO_NONE,  .available_alloc = IO_GPIO }
