...
static io_table_t io_porth =
{
	...
	.pins =
	{
		...
		{ .pin = GPIOH_OTG_HS_ULPI_NXT,        .default_mode = PAL_STM32_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .current_mode = PAL_MODE_INPUT | PAL_STM32_PUDR_FLOATING, .default_alloc = IO_USB, .current_alloc = IO_USB,  .available_alloc = IO_NONE } ,
